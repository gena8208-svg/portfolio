                ...
                <div class="modal-body">
                    <form id="adduserModalForm">
                        ...
                        <div class="mb-2">
                            ...
                            <div>
                                <select class="form-select" id="office" name="office" required>
                                    ...
                                    if (isset($_SESSION['office']) && $_SESSION['office'] != 'P0') {
                                        $officeId = $_SESSION['office'];
                                        $sql = "SELECT id, priznak FROM offices WHERE priznak IN ('CL', 'CLU')";
                                        try {
                                            $pdo = pdo();
                                            $result = $pdo->query($sql);
                                            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                                $selected = ($row['id'] == $officeId) ? 'selected' : '';
                                                echo "<option value='" . htmlspecialchars($row['id']) . "'" . $selected . '>' . htmlspecialchars($row['priznak']) . '</option>';
                                            }
                                    ...
                                    ?>
                                    <select class="form-select" id="office" name="office" required>
                                        <?php if (isset($_SESSION['office']) && $_SESSION['office'] != 'P0') { ?>
                                            <script>
                                                document.getElementById('office').readOnly = true;
                                            </script>
                                        <?php } ?>
                                    </select>
                            </div>
                        ...
                        <div class="d-flex mb-2">
                            <input type="text" class="form-control me-2" id="password" name="password" autocomplete="off" <?php if ($_SESSION['office'] != 'P0') echo 'readonly'; ?>>
                            <!--  <button class="btn btn-sm btn-primary" title="Генерировать" id="generator-btn" name="generator" <?php if ($password != '') echo 'disabled'; ?>><i class="bi bi-bootstrap-reboot"></i></button> -->
