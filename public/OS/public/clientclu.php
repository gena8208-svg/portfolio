...
<body>
    <div class="container-fluid">
        <nav class="navbar">
            <div class="container-fluid">
                ...
                <i class="bi bi-info-square text-primary" style="font-size:1.3em" data-bs-toggle="modal" data-bs-target="#myModal" role="button"></i>
            ...
            <div class="mt-5 mb-2">
                <div class="row align-items-center">
                    <div class="col-6 col-md-4">
                        <span class="border p-1 rounded border-success" style="background-color: #f8f9fa; font-size: 1em;">Баланс: <span id="totalSumup">0</span></span>
                    </div>

                    <div class="col-6 col-md-4">
                        <div class="d-flex align-items-center">
                            <label for="datetimePickerStart" class="me-1 ms-2">С:</label>
        ...
        <div class="mb-3  border-danger">
            <span class="border p-1 rounded border-danger" style="background-color:#f8f9fa; font-size: 1em;">Лимит: <span id="limit">0</span></span>
        </div>
        ...
        <div class="text-itogi">
            <p>
                <i class="bi bi-arrow-left-right"></i> Оплата:
    ...
    <script>
            ...
            table = $("#client-table").DataTable({
                ...
                ajax: {
                    ...
                    success: function(response) {
                        ...
                        $('#paymentTotal').text(response.totals.total_payment || 0);
        ...
        $('#datefilterbtn').on('click', function() {
            ...
            $.ajax({
                url: "filter_date_clientu_table.php",
                method: "POST",
                data: {
