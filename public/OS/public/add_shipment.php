...
try {
    ...
    $logMessage = "";
    $logMessage = "[" . $todayDate . "] Операция: отгрузка со склада\n";
    $logMessage .= "id клиента: " . $site_id . ", Сумма отгрузки: " . $shipment . "\n";
    error_log($logMessage, 3, 'logs/otgruzka_v_kasse.log', FILE_APPEND);
    $balance = (int)$totalsum + $shipment;
